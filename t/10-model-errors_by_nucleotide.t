...
use_ok('npg_qc::model::errors_by_nucleotide');
my $util = t::util->new({fixtures =>1});
{
  my $model = npg_qc::model::errors_by_nucleotide->new({
    util                    => $util,
    id_errors_by_nucleotide => 1,
    id_run_tile             => 1,
  });
  isa_ok($model, 'npg_qc::model::errors_by_nucleotide', '$model');
