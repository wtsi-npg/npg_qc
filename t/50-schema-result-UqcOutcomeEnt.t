...
subtest 'Misc tests' => sub {
  ...
  my $values = {
    ...
    'modified_by'=>'user',
    'rationale'=>'user reason for change 1'
  };
  ...
  $values1{'rationale'}='user reason for change 2';
  ...
  $values = {
      ...
      'last_modified'=>DateTime->now(),
      'modified_by'=>'user3',
      'rationale'=>'user reason for change 3'
  };
  ...
  $values = {
    ...
    'last_modified'=>DateTime->now(),
    'modified_by'=>'user4',
    'rationale'=>'user reason for change 4'
  };
  ...
  $values = {
    ...
    'last_modified'  => DateTime->now(),
    'modified_by'    => 'user5',
    'rationale'=>'user reason for change 5'
  };
  ...
  $values = {
    ...
    'last_modified'  => DateTime->now(),
    'modified_by'    => 'user6',
    'rationale'=>'user reason for change 6'
  };
  ...
  $values = {
    ...
    'rationale'=>'user reason for change 7'
  };
  isa_ok($schema->resultset($table)->create($values),
    'npg_qc::Schema::Result::UqcOutcomeEnt');
  ...
  is ($rs->count, 1, q[one row created in the table]);
  $object = $rs->next();
  is($object->id_uqc_outcome, 1, q[The outcome id is correct]);
  ok(defined $object->uqc_outcome, q[The outcome is defined when searching.]);
...
#   is($entity->id_uqc_outcome, $historic->{'id_uqc_outcome'}, 'Id mqc outcome matches');
