...

{
 ...
 is ($check->result->comments, 'Neither t/data/autoqc/090721_IL29_2549/data/2549_1_1.bam.tag_decode.metrics no t/data/autoqc/090721_IL29_2549/data/2549_1.bam.tag_decode.metrics file found', 'comment with an error');
}
