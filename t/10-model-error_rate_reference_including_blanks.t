...
use_ok('npg_qc::model::error_rate_reference_including_blanks');
my $util = t::util->new({fixtures =>1});
{
  my $model = npg_qc::model::error_rate_reference_including_blanks->new({
    util                                     => $util,
    id_error_rate_reference_including_blanks => 1,
    id_run_tile                              => 1,
  });
  isa_ok($model, 'npg_qc::model::error_rate_reference_including_blanks', '$model');
