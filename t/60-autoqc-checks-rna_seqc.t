...
print $fh q{if [[ "$1" =~ $rpt_regex ]]; then bam=$1; break; elif [[ "$1" = -H ]]; then print=header; elif [[ "$1" = -c ]]; then print=count; fi; shift;}.qq{\n};
print $fh q{done}.qq{\n};
print $fh q{if [ "$print" = "header" ]; then grep '@' $bam; elif [ "$print" = "count" ]; then echo 100; fi;}.qq{\n};
print $fh q{exit 0};
close $fh;
...
'Mitochondrial % TPM' => '6.56','No. Covered 5\'' => '439','Note' => '3521885','Num. Gaps' => '5079',
