...
Readonly::Scalar my $SAMTOOLS_MPILEUP_NAME => q[samtools]; # old mpileup format still needed until new bcftools can be used
...
Readonly::Scalar my $DEFAULT_MIN_COMMON_SNPS => 20;
