...
=cut
has 'report_dir'  => (isa       => 'NpgTrackingDirectory',
                      is        => 'ro',
                      required  => 0,
                      predicate => '_has_report_dir',
                      writer    => '_write_report_dir',
...
sub _create_test_object {
    ...
    my @attrs = qw/tag_index repository reference_genome species strain file_type qc_out report_dir/;
