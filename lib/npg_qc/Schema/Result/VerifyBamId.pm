...
=head2 C<verify_bam_id_compos_ind_unique>
...
__PACKAGE__->add_unique_constraint('verify_bam_id_compos_ind_unique', ['id_seq_composition']);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AaSSO7vM8dSk1dYV9FNKXQ
