...
package npg_qc::Schema::Result::RefMatch;
...
=head1 TABLE: C<ref_match>

=cut

__PACKAGE__->table('ref_match');
...
__PACKAGE__->set_primary_key('id_ref_match');

=head1 UNIQUE CONSTRAINTS

=head2 C<ref_match_compos_ind_unique>
...
__PACKAGE__->add_unique_constraint('ref_match_compos_ind_unique', ['id_seq_composition']);
...
with 'npg_qc::Schema::Composition', 'npg_qc::Schema::Flators', 'npg_qc::autoqc::role::result', 'npg_qc::autoqc::role::ref_match';


# Created by DBIx::Class::Schema::Loader v0.07047 @ 2017-09-14 16:25:18
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tz6CkYNlRjjnVZaXpsYBeQ
